abstract class Strings {
  ...
  static const texte5 =
      ...
      "Il existe différentes levures. Nous vous recommandons d’utiliser des levures sèches qui sont mieux adaptées pour des petits brassins. Se référer à l’emballage pour déterminer au mieux la quantité appropriée. Il est recommandé d’utiliser pour débuter de la levure S33 qui est polyvalente.\n Incorporer la levure et remuer la bonbonne pour mélanger.\n \n Dans une pièce à 20°C, fermer la bonbonne et placer le barboter (qui permet d’évacuer l’oxygène). \n"
  ...
  static const appBartitle = "BeerMaker";

  static const textButton1 = "Etape de fabrication";
  static const textButton2 = "Outils de fabrication";
}
